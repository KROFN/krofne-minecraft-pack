...
import { BACKUP_FOLDER_NAME, DISABLED_FOLDER_NAME, DOWNLOAD_CACHE_FOLDER_NAME } from '../../shared/constants';
...
/**
 * Returns the path to the download cache directory within the mods folder.
 */
export function getCacheDir(modsPath: string): string {
  return safeJoin(modsPath, DOWNLOAD_CACHE_FOLDER_NAME);
}
